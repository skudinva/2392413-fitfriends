function PersonalAccountCoachAdditional(): JSX.Element {
  return (
    <div className="personal-account-coach__additional-info is-disabled">
...
export default PersonalAccountCoachAdditional;
